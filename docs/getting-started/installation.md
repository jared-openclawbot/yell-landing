...
- [Quick start](/yell-landing/docs/getting-started/quick-start.html) — render your first YAML
- [Create a component registry](/yell-landing/docs/core-concepts/components.html)